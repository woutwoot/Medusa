                            ...
                            <fieldset class="component-group-list">
                                ...
                                <div v-show="clients.torrents.enabled">
                                    ...
                                    <div v-if="clients.torrents.method" v-show="clients.torrents.method === 'blackhole'">
                                        ...
                                        <config-toggle-slider v-model="clients.torrents.forceMagnet" label="Save magnet links as .magnet files" id="force_magnet" :explanations="['Save magnet links as .magnet files']"></config-toggle-slider>
